...
{
  int i, mapi;
  char input, kalimat[10], hasil[10];
  stack tumpukan;
  ...
  case 1:
    ...
    for (i = 0; i < isi; i++) {
      cout << “Masukkan isi tumpukan ke - “ << i + 1 << “;”;
      cin >> input;
...
int srch() {
  ...
  case 2:
    ...
    system(“color 6”);
    cout << “Masukan NIM Mahasiswa TI = A”;
    cin >> a;
    search(a);
    break;
  ...
  case 3:
    ...
    if (tm > 0) {
      ...
      cout << “Data tidak ditemukan dalam array\ n”;
    }
    getch();
    break;
    return 0;
...
int srt() {
  ...
  if (mpa == 1) {
    ...
    cout << “\n\ n data Setelah diurutkan secara descending: “;
    for (ii = 1; ii <= ix; ii++) {
      cout << ”“ << ia[ii];
    }
  }
...
int tng() {
  ...
  if (maspil == 1) {
    ...
    while (1) {
      ...
      case 3:
        cout << “Menghitung Jumlah simpul” << endl;
        cout << “——————“ << endl;
